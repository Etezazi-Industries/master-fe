...
function EmailManager({ groups = [], onChange }) {
  ...
  const updateCache = (0, import_react.useCallback)((updater) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { className: "mb-2" }, /* @__PURE__ */ import_react.default.createElement(
    "select",
    {
