...
// src/renderer/vendor_quoting/components/BoeingFinishModal.jsx
...
function BoeingFinishModal({ onClose }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "modal fade show", style: { display: "block" }, tabIndex: "-1" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-dialog modal-lg" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-header" }, /* @__PURE__ */ import_react.default.createElement("h5", { className: "modal-title" }, "Boeing finish codes"), /* @__PURE__ */ import_react.default.createElement(
    "button",
    {
      type: "button",
      className: "btn-close",
  ...
  )), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-body" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "mb-3" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "input-group" }, /* @__PURE__ */ import_react.default.createElement(
    "input",
    {
      type: "text",
  ...
  )), /* @__PURE__ */ import_react.default.createElement("div", { className: "form-text text-muted" }, "Press Enter to search.")), /* @__PURE__ */ import_react.default.createElement("div", { className: "results-area" }, loading && /* @__PURE__ */ import_react.default.createElement("div", { className: "text-center py-4" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "spinner-border spinner-border-sm me-2", role: "status" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "visually-hidden" }, "Loading...")), "Loading..."), error && /* @__PURE__ */ import_react.default.createElement("div", { className: "alert alert-danger alert-dismissible", role: "alert" }, error, /* @__PURE__ */ import_react.default.createElement(
    "button",
    {
      type: "button",
      className: "btn-close",
  ...
  )), data && !loading && !error && /* @__PURE__ */ import_react.default.createElement("div", null, data.results && data.results.length > 0 ? data.results.map((result, resultIndex) => /* @__PURE__ */ import_react.default.createElement("div", { key: resultIndex, className: "card mb-4" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "card-header" }, /* @__PURE__ */ import_react.default.createElement("h6", { className: "card-title mb-0" }, result.process_code, /* @__PURE__ */ import_react.default.createElement("small", { className: "text-muted ms-2" }, "(", result.suppliers.length, " supplier", result.suppliers.length !== 1 ? "s" : "", ")"))), /* @__PURE__ */ import_react.default.createElement("div", { className: "card-body" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "card-text mb-3" }, result.nomenclature), /* @__PURE__ */ import_react.default.createElement("div", { className: "row mb-3" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "col-md-6" }, /* @__PURE__ */ import_react.default.createElement("small", { className: "text-muted" }, "Specification Number:"), /* @__PURE__ */ import_react.default.createElement("div", { className: "fw-medium" }, result.specification_number)), /* @__PURE__ */ import_react.default.createElement("div", { className: "col-md-6" }, /* @__PURE__ */ import_react.default.createElement("small", { className: "text-muted" }, "Specification Title:"), /* @__PURE__ */ import_react.default.createElement("div", { className: "fw-medium" }, result.specification_title))), result.url && /* @__PURE__ */ import_react.default.createElement("div", { className: "mb-3" }, /* @__PURE__ */ import_react.default.createElement(
    "a",
    {
      href: result.url,
      target: "_blank",
    ...
    /* @__PURE__ */ import_react.default.createElement("i", { className: "bi bi-box-arrow-up-right me-1" }),
    "View on Boeing"
  )), /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h6", { className: "mb-2" }, "Approved Suppliers"), result.suppliers && result.suppliers.length > 0 ? /* @__PURE__ */ import_react.default.createElement("div", { className: "table-responsive" }, /* @__PURE__ */ import_react.default.createElement("table", { className: "table table-sm table-striped" }, /* @__PURE__ */ import_react.default.createElement("thead", null, /* @__PURE__ */ import_react.default.createElement("tr", null, /* @__PURE__ */ import_react.default.createElement("th", null, "Country"), /* @__PURE__ */ import_react.default.createElement("th", null, "State"), /* @__PURE__ */ import_react.default.createElement("th", null, "Processor Code"), /* @__PURE__ */ import_react.default.createElement("th", null, "Processor Name"))), /* @__PURE__ */ import_react.default.createElement("tbody", null, result.suppliers.map((supplier, supplierIndex) => /* @__PURE__ */ import_react.default.createElement("tr", { key: supplierIndex }, /* @__PURE__ */ import_react.default.createElement("td", null, supplier.country), /* @__PURE__ */ import_react.default.createElement("td", null, supplier.state || "\u2014"), /* @__PURE__ */ import_react.default.createElement("td", null, supplier.processor_code), /* @__PURE__ */ import_react.default.createElement("td", null, supplier.processor_name)))))) : /* @__PURE__ */ import_react.default.createElement("p", { className: "text-muted" }, "No approved suppliers found for this process code."))))) : /* @__PURE__ */ import_react.default.createElement("div", { className: "alert alert-warning" }, 'No results found for "', data.search_term, '". Try a different search term.')))), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-footer" }, /* @__PURE__ */ import_react.default.createElement("button", { type: "button", className: "btn btn-secondary", onClick: onClose }, "Close")))));
}
var modalRoot = null;
var modalContainer = null;
function openBoeingFinishModal() {
  if (!modalContainer) {
  ...
  if (!modalRoot) {
    modalRoot = (0, import_client.createRoot)(modalContainer);
  }
  const handleClose = () => {
  ...
  modalRoot.render(
    import_react.default.createElement(BoeingFinishModal, { onClose: handleClose })
  );
}
export {
