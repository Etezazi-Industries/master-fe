...
function BoeingFinishModal({ onClose }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "modal fade show", style: { display: "block" }, tabIndex: "-1" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-dialog modal-lg" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-header" }, /* @__PURE__ */ import_react.default.createElement("h5", { className: "modal-title" }, "Boeing finish codes"), /* @__PURE__ */ import_react.default.createElement(
  ...
  )), data && !loading && !error && /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { className: "card mb-3" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "card-body" }, /* @__PURE__ */ import_react.default.createElement("h6", { className: "card-title" }, data.process_code), /* @__PURE__ */ import_react.default.createElement("p", { className: "card-text" }, data.nomenclature), /* @__PURE__ */ import_react.default.createElement("div", { className: "row" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "col-md-6" }, /* @__PURE__ */ import_react.default.createElement("small", { className: "text-muted" }, "Specification Number:"), /* @__PURE__ */ import_react.default.createElement("div", null, data.specification_number)), /* @__PURE__ */ import_react.default.createElement("div", { className: "col-md-6" }, /* @__PURE__ */ import_react.default.createElement("small", { className: "text-muted" }, "Specification Title:"), /* @__PURE__ */ import_react.default.createElement("div", null, data.specification_title))), data.url && /* @__PURE__ */ import_react.default.createElement("div", { className: "mt-2" }, /* @__PURE__ */ import_react.default.createElement(
    "a",
    {
      href: data.url,
      target: "_blank",
    ...
    "View on Boeing"
  )))), /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h6", null, "Approved Suppliers"), data.suppliers && data.suppliers.length > 0 ? /* @__PURE__ */ import_react.default.createElement("table", { className: "table table-sm table-striped" }, /* @__PURE__ */ import_react.default.createElement("thead", null, /* @__PURE__ */ import_react.default.createElement("tr", null, /* @__PURE__ */ import_react.default.createElement("th", null, "Country"), /* @__PURE__ */ import_react.default.createElement("th", null, "State"), /* @__PURE__ */ import_react.default.createElement("th", null, "Processor Code"), /* @__PURE__ */ import_react.default.createElement("th", null, "Processor Name"))), /* @__PURE__ */ import_react.default.createElement("tbody", null, data.suppliers.map((supplier, index) => /* @__PURE__ */ import_react.default.createElement("tr", { key: index }, /* @__PURE__ */ import_react.default.createElement("td", null, supplier.country), /* @__PURE__ */ import_react.default.createElement("td", null, supplier.state || "\u2014"), /* @__PURE__ */ import_react.default.createElement("td", null, supplier.processor_code), /* @__PURE__ */ import_react.default.createElement("td", null, supplier.processor_name))))) : /* @__PURE__ */ import_react.default.createElement("p", { className: "text-muted" }, "No approved suppliers found."))))), /* @__PURE__ */ import_react.default.createElement("div", { className: "modal-footer" }, /* @__PURE__ */ import_react.default.createElement("button", { type: "button", className: "btn btn-secondary", onClick: onClose }, "Close")))));
}
var modalRoot = null;
