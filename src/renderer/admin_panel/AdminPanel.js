...
// src/renderer/admin_panel/AdminPanel.jsx
...
// src/renderer/admin_panel/components/UserList.jsx
var import_react2 = __toESM(require_react(), 1);
function UserList({ users, selectedUser, onSelectUser, isLoading }) {
  ...
  if (isLoading) {
    return /* @__PURE__ */ import_react2.default.createElement("div", { style: containerStyle }, /* @__PURE__ */ import_react2.default.createElement("div", { style: headerStyle }, /* @__PURE__ */ import_react2.default.createElement("h6", { className: "mb-0" }, /* @__PURE__ */ import_react2.default.createElement("i", { className: "bi bi-people-fill me-2" }), "User Information")), /* @__PURE__ */ import_react2.default.createElement("div", { className: "text-center py-4" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "spinner-border", style: { color: "#60a5fa" }, role: "status" }, /* @__PURE__ */ import_react2.default.createElement("span", { className: "visually-hidden" }, "Loading...")), /* @__PURE__ */ import_react2.default.createElement("div", { className: "mt-2" }, /* @__PURE__ */ import_react2.default.createElement("small", { style: { color: "#94a3b8" } }, "Loading users..."))));
  }
  if (!users || users.length === 0) {
    return /* @__PURE__ */ import_react2.default.createElement("div", { style: containerStyle }, /* @__PURE__ */ import_react2.default.createElement("div", { style: headerStyle }, /* @__PURE__ */ import_react2.default.createElement("h6", { className: "mb-0" }, /* @__PURE__ */ import_react2.default.createElement("i", { className: "bi bi-people-fill me-2" }), "User Information")), /* @__PURE__ */ import_react2.default.createElement("div", { className: "text-center py-4" }, /* @__PURE__ */ import_react2.default.createElement("i", { className: "bi bi-inbox", style: { fontSize: "2rem", color: "#94a3b8" } }), /* @__PURE__ */ import_react2.default.createElement("div", { className: "mt-2" }, /* @__PURE__ */ import_react2.default.createElement("small", { style: { color: "#94a3b8" } }, "No users found"))));
  }
  return /* @__PURE__ */ import_react2.default.createElement("div", { style: containerStyle }, /* @__PURE__ */ import_react2.default.createElement("div", { style: headerStyle }, /* @__PURE__ */ import_react2.default.createElement("h6", { className: "mb-0" }, /* @__PURE__ */ import_react2.default.createElement("i", { className: "bi bi-people-fill me-2" }), "User Information (", users.length, " users)")), /* @__PURE__ */ import_react2.default.createElement("div", { style: listStyle }, users.map((user, index) => {
    ...
    return /* @__PURE__ */ import_react2.default.createElement(
      ...
      /* @__PURE__ */ import_react2.default.createElement("div", null, /* @__PURE__ */ import_react2.default.createElement("div", { className: "fw-semibold", style: { color: "#e2e8f0" } }, user.name || user.company_name || `User ${index + 1}`), /* @__PURE__ */ import_react2.default.createElement("small", { style: { color: "#94a3b8" } }, user.email || user.contact_email || "No email"), user.phone && /* @__PURE__ */ import_react2.default.createElement("div", null, /* @__PURE__ */ import_react2.default.createElement("small", { style: { color: "#94a3b8" } }, /* @__PURE__ */ import_react2.default.createElement("i", { className: "bi bi-telephone me-1" }), user.phone))),
      /* @__PURE__ */ import_react2.default.createElement("div", { className: "text-end" }, /* @__PURE__ */ import_react2.default.createElement("small", { style: { color: "#94a3b8" } }, "ID: ", user.pk || user.id || index + 1), user.created_at && /* @__PURE__ */ import_react2.default.createElement("div", null, /* @__PURE__ */ import_react2.default.createElement("small", { style: { color: "#94a3b8" } }, new Date(user.created_at).toLocaleDateString())))
    );
  })));
}

// src/renderer/admin_panel/components/ApplicationList.jsx
var import_react3 = __toESM(require_react(), 1);
function ApplicationList({ applications, selectedApplication, onSelectApplication }) {
  const containerStyle = {
    background: "#1a1f2e",
    border: "1px solid #2d3748",
    borderRadius: "0.5rem",
  ...
  const getStatusBadge = (status) => {
    const badgeClass = status === "active" ? "bg-success" : status === "maintenance" ? "bg-warning" : "bg-secondary";
    return /* @__PURE__ */ import_react3.default.createElement("span", { className: `badge ${badgeClass}` }, status || "active");
  };
  ...
  return /* @__PURE__ */ import_react3.default.createElement("div", { style: containerStyle }, /* @__PURE__ */ import_react3.default.createElement("div", { style: headerStyle }, /* @__PURE__ */ import_react3.default.createElement("h6", { className: "mb-0" }, /* @__PURE__ */ import_react3.default.createElement("i", { className: "bi bi-grid-3x3-gap-fill me-2" }), "Applications (", applications.length, " apps)")), /* @__PURE__ */ import_react3.default.createElement("div", { style: listStyle }, applications.map((app, index) => {
    ...
    return /* @__PURE__ */ import_react3.default.createElement(
      ...
      /* @__PURE__ */ import_react3.default.createElement("div", { className: "d-flex align-items-center" }, /* @__PURE__ */ import_react3.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react3.default.createElement("i", { className: getApplicationIcon(app.id), style: { fontSize: "1.1rem" } })
      ), /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement("div", { className: "fw-semibold", style: { color: "#e2e8f0" } }, app.name), /* @__PURE__ */ import_react3.default.createElement("small", { style: { color: "#94a3b8" } }, app.description))),
      /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-end" }, getStatusBadge(app.status), app.version && /* @__PURE__ */ import_react3.default.createElement("div", { className: "mt-1" }, /* @__PURE__ */ import_react3.default.createElement("small", { style: { color: "#94a3b8" } }, "v", app.version)))
    );
  })));
}
...
function AdminPanel() {
  ...
  const [applications, setApplications] = (0, import_react4.useState)([]);
  const [selectedApplication, setSelectedApplication] = (0, import_react4.useState)(null);
  ...
  const loadUsers = (0, import_react4.useCallback)(async () => {
    setIsLoading(true);
    try {
  ...
  const loadApplications = (0, import_react4.useCallback)(() => {
    setApplications(hardCodedApplications);
  }, []);
  const handleSelectUser = (0, import_react4.useCallback)((user) => {
    setSelectedUser(user);
    console.log("[admin] Selected user:", user);
  }, []);
  const handleSelectApplication = (0, import_react4.useCallback)((application) => {
    setSelectedApplication(application);
    console.log("[admin] Selected application:", application);
  }, []);
  const handleRefreshUsers = (0, import_react4.useCallback)(() => {
    loadUsers();
  }, [loadUsers]);
  const handleGiveAccess = (0, import_react4.useCallback)(async () => {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("div", { className: "text-light", style: {
    ...
    HeaderBar,
    {
      ...
      sticky: true,
      actions: /* @__PURE__ */ import_react4.default.createElement("div", { className: "d-flex align-items-center gap-2" }, /* @__PURE__ */ import_react4.default.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ import_react4.default.createElement("i", { className: `bi bi-arrow-clockwise ${isLoading ? "spin" : ""}` })
      ), /* @__PURE__ */ import_react4.default.createElement(
        "button",
        {
          className: "btn btn-outline-light btn-sm",
        ...
        /* @__PURE__ */ import_react4.default.createElement("i", { className: "bi bi-gear" })
      ))
    }
  ), /* @__PURE__ */ import_react4.default.createElement(
    "div",
    {
      ...
      style: {
        ...
        position: "relative",
        height: 0
        // Force height calculation from flex
      }
    },
    /* @__PURE__ */ import_react4.default.createElement("div", { className: "container-fluid", style: {
      maxWidth: "1400px",
      margin: "0 auto",
      padding: "2rem"
    } }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "row mb-4" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "col-md-4" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "card dark-summary-card border-0 shadow-sm" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "card-body text-center" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "mb-2", style: { color: "#60a5fa" } }, /* @__PURE__ */ import_react4.default.createElement("i", { className: "bi bi-people-fill", style: { fontSize: "2rem" } })), /* @__PURE__ */ import_react4.default.createElement("h4", { className: "mb-1 text-light" }, users.length), /* @__PURE__ */ import_react4.default.createElement("small", { style: { color: "#94a3b8" } }, "Total Users")))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "col-md-4" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "card dark-summary-card border-0 shadow-sm" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "card-body text-center" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "mb-2", style: { color: "#34d399" } }, /* @__PURE__ */ import_react4.default.createElement("i", { className: "bi bi-grid-3x3-gap-fill", style: { fontSize: "2rem" } })), /* @__PURE__ */ import_react4.default.createElement("h4", { className: "mb-1 text-light" }, applications.length), /* @__PURE__ */ import_react4.default.createElement("small", { style: { color: "#94a3b8" } }, "Available Apps")))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "col-md-4" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "card dark-summary-card border-0 shadow-sm" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "card-body text-center" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "mb-2", style: { color: "#fbbf24" } }, /* @__PURE__ */ import_react4.default.createElement("i", { className: "bi bi-shield-check", style: { fontSize: "2rem" } })), /* @__PURE__ */ import_react4.default.createElement("h4", { className: "mb-1 text-light" }, selectedUser && selectedApplication ? "1" : "0"), /* @__PURE__ */ import_react4.default.createElement("small", { style: { color: "#94a3b8" } }, "Ready to Grant"))))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "row" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "col-lg-6 mb-4" }, /* @__PURE__ */ import_react4.default.createElement(
      UserList,
      {
        users,
        selectedUser,
    ...
    )), /* @__PURE__ */ import_react4.default.createElement("div", { className: "col-lg-6 mb-4" }, /* @__PURE__ */ import_react4.default.createElement(
      ApplicationList,
      {
        applications,
        selectedApplication,
    ...
    ))), (selectedUser || selectedApplication) && /* @__PURE__ */ import_react4.default.createElement("div", { className: "row" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "col-12" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "card dark-card border-0 shadow-sm" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "card-header", style: { background: "#2d3748", borderBottom: "1px solid #4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("h6", { className: "mb-0 text-light" }, /* @__PURE__ */ import_react4.default.createElement("i", { className: "bi bi-info-circle me-2", style: { color: "#60a5fa" } }), "Selection Details")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "card-body", style: { background: "#1a1f2e" } }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "row" }, selectedUser && /* @__PURE__ */ import_react4.default.createElement("div", { className: "col-md-6" }, /* @__PURE__ */ import_react4.default.createElement("h6", { style: { color: "#60a5fa" } }, "Selected User"), /* @__PURE__ */ import_react4.default.createElement("table", { className: "table table-sm table-dark" }, /* @__PURE__ */ import_react4.default.createElement("tbody", null, /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#94a3b8", borderColor: "#4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("strong", null, "Name:")), /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#e2e8f0", borderColor: "#4a5568" } }, selectedUser.name || selectedUser.company_name || "N/A")), /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#94a3b8", borderColor: "#4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("strong", null, "Email:")), /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#e2e8f0", borderColor: "#4a5568" } }, selectedUser.email || selectedUser.contact_email || "N/A")), /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#94a3b8", borderColor: "#4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("strong", null, "Phone:")), /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#e2e8f0", borderColor: "#4a5568" } }, selectedUser.phone || "N/A")), /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#94a3b8", borderColor: "#4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("strong", null, "ID:")), /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#e2e8f0", borderColor: "#4a5568" } }, selectedUser.pk || selectedUser.id || "N/A")), selectedUser.created_at && /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#94a3b8", borderColor: "#4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("strong", null, "Created:")), /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#e2e8f0", borderColor: "#4a5568" } }, new Date(selectedUser.created_at).toLocaleString()))))), selectedApplication && /* @__PURE__ */ import_react4.default.createElement("div", { className: "col-md-6" }, /* @__PURE__ */ import_react4.default.createElement("h6", { style: { color: "#34d399" } }, "Selected Application"), /* @__PURE__ */ import_react4.default.createElement("table", { className: "table table-sm table-dark" }, /* @__PURE__ */ import_react4.default.createElement("tbody", null, /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#94a3b8", borderColor: "#4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("strong", null, "Name:")), /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#e2e8f0", borderColor: "#4a5568" } }, selectedApplication.name)), /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#94a3b8", borderColor: "#4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("strong", null, "Description:")), /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#e2e8f0", borderColor: "#4a5568" } }, selectedApplication.description)), /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#94a3b8", borderColor: "#4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("strong", null, "Status:")), /* @__PURE__ */ import_react4.default.createElement("td", { style: { borderColor: "#4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("span", { className: `badge ${selectedApplication.status === "active" ? "bg-success" : selectedApplication.status === "maintenance" ? "bg-warning" : "bg-secondary"}` }, selectedApplication.status))), /* @__PURE__ */ import_react4.default.createElement("tr", null, /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#94a3b8", borderColor: "#4a5568" } }, /* @__PURE__ */ import_react4.default.createElement("strong", null, "Version:")), /* @__PURE__ */ import_react4.default.createElement("td", { style: { color: "#e2e8f0", borderColor: "#4a5568" } }, "v", selectedApplication.version)))))))))), selectedUser && selectedApplication && /* @__PURE__ */ import_react4.default.createElement("div", { className: "row mt-4" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "col-12" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "d-flex justify-content-center" }, /* @__PURE__ */ import_react4.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react4.default.createElement("i", { className: "bi bi-shield-check me-2" }),
      "Give Access"
    )), /* @__PURE__ */ import_react4.default.createElement("div", { className: "text-center mt-3" }, /* @__PURE__ */ import_react4.default.createElement("small", { style: { color: "#94a3b8" } }, "Grant ", /* @__PURE__ */ import_react4.default.createElement("strong", { style: { color: "#60a5fa" } }, selectedUser.name || selectedUser.id), " access to ", /* @__PURE__ */ import_react4.default.createElement("strong", { style: { color: "#34d399" } }, selectedApplication.name))))))
  )));
}
var appRoot = null;
function mountAdminPanel() {
  ...
  if (!container) {
    ...
    console.log(
      "[admin-panel] Available containers:",
  ...
  if (!appRoot) {
    appRoot = (0, import_client.createRoot)(container);
  }
  console.log("[admin-panel] Rendering AdminPanel component...");
  appRoot.render(/* @__PURE__ */ import_react4.default.createElement(AdminPanel, null));
